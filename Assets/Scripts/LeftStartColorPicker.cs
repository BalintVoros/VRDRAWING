...
public class LeftStartColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    private const float recip2Pi = 0.159154943f;
    private const string colorPickerShaderName = "UI/LeftStartColorPicker";
...
//        go.AddComponent<LeftStartColorPicker>();
