...
public class RightStartColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    private const float recip2Pi = 0.159154943f;
    private const string colorPickerShaderName = "UI/RightStartColorPicker";
...
//        go.AddComponent<RightStartColorPicker>();
