...
public class LeftEndColorPicker : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    private const float recip2Pi = 0.159154943f;
    private const string colorPickerShaderName = "UI/LeftEndColorPicker";
...
//        go.AddComponent<LeftEndColorPicker>();
